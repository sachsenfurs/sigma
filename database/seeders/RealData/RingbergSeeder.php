    ...
    public function run()
    {
        $locations = [
            ...
            [
                'name' => "Frühstücksraum",
                'name_en' => "Breakfast Area",
                'description' => "Artist Lounge",
                'description_en' => "Artist Lounge",
                'render_ids' => json_encode(["brekkyArea2", "brekkyArea3"]),
                'floor' => "0",
                "essential_description" => "In Ruhe zeichnen? Auf einer Convention?? Hier ist es möglich! \nHier kannst du in Ruhe sitzen, ohne komplett von der EAST ausgeschlossen zu sein.",
                "essential_description_en" => "Drawing in peace? At a convention?? It’s possible here! \nYou can enjoy a quiet space to sit and draw without feeling completely disconnected from the EAST.",
                "essential" => true,
            ],
            [
                'name' => "Bar",
