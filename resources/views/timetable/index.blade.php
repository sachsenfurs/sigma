                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-1 row">
                                <div class="col-6">
                                    <input type="datetime-local" class="form-control" name="start" value="{{ \Carbon\Carbon::now()->format("Y-m-d\TH:i:s") }}">
                                </div>
                                <div class="col-6">
                                    <input type="datetime-local" class="form-control" name="end" value="{{ \Carbon\Carbon::now()->format("Y-m-d\TH:i:s") }}">
                                </div>
                            </div>
                        </div>
