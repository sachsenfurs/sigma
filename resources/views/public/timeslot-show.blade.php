...
@section('content')
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route("public.tableview") }}">{{ __("Event Schedule") }}</a></li>
                <li class="breadcrumb-item"><a href="{{ route("public.tableview") }}">{{ $entry->start->dayName }}</a></li>
